...
- **3. Print integer**
  ...
  - Completion of [this source code](3-print_number.py).
...
- **4. Print float**
  ...
  - Completion of [this source code](4-print_float.py).
...
School!` using the variables `str1 = "Holberton"` and `str2 = "School"`.
  - Completion of [this source code](6-concat.py).
...
- **7. Copy - Cut - Paste**
  ...
  - Completion of [this source code](7-edges.py).
...
programming with Python`, followed by a new line without creating new variables or
    string literals.
  - Completion of [this source code](8-concat_edges.py).
